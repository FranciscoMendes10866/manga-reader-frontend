...
export type GetChapterQuery = {
  ...
  chapter?:
    | {
        ...
        ID?: string | null | undefined;
        name?: string | null | undefined;
        manga_id?: string | null | undefined;
        pages?:
          | Array<
              | { __typename?: 'Pages'; url?: string | null | undefined }
              | null
              | undefined
            >
          | null
...
export type GetMangaDetailsQuery = {
  __typename?: 'Query';
  details?:
    | {
        __typename?: 'GetMangaDetailsResponse';
...
export function useGetChapterQuery(
  options: Omit<Urql.UseQueryArgs<GetChapterQueryVariables>, 'query'> = {}
) {
  return Urql.useQuery<GetChapterQuery>({
...
export function useGetMangaDetailsQuery(
  options: Omit<Urql.UseQueryArgs<GetMangaDetailsQueryVariables>, 'query'> = {}
) {
  return Urql.useQuery<GetMangaDetailsQuery>({
    query: GetMangaDetailsDocument,
    ...options,
  });
}
